/**
 * GET  /api/v1/electricity  — List electricity logs
 * POST /api/v1/electricity  — Create electricity log
 *
 * Based on: docs/11_API_SPECIFICATION.md
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    const input = CreateResourceLogSchema.parse({
      ...body,
      resourceType: ResourceType.Electricity,
    });
