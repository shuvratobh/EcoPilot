/**
 * GET  /api/v1/recycling  — List recycling logs
 * POST /api/v1/recycling  — Create recycling log
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    const input = CreateResourceLogSchema.parse({ ...body, resourceType: ResourceType.Recycling });
